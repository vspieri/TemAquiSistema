...
namespace Tem_Aqui.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LoginNome,LoginSenha")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LoginNome,LoginSenha")] Login login)
        {
            if (id != login.Id)
            {
                return NotFound();
